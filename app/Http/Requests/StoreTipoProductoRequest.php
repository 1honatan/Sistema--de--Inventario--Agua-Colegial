...
/**
 * Request de validación para crear tipo de producto.
 */
class StoreTipoProductoRequest extends FormRequest
{
    ...
    {
        // Solo administradores pueden crear tipos de producto
    ...
    public function rules(): array
    {
        return [
            'nombre' => [
                ...
                'string',
                'max:100',
                'unique:tipos_producto,nombre',
            ],
            'codigo' => [
                'required',
                'string',
                'max:20',
                'unique:tipos_producto,codigo',
