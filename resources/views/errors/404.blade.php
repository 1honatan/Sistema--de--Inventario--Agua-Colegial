...
<head>
    ...
    <title>404 - Página no encontrada | Agua Colegial</title>
    ...
    <style>
        ...
        body {
            background: linear-gradient(135deg, #073d71 0%, #0a4d8f 50%, #1a8cff 100%);
    ...
    <div class="error-container">
        <div class="error-card">
            ...
            <div class="error-header">
                ...
                <p class="text-xl font-semibold mt-2">Página no encontrada</p>
            </div>
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">
                    La página que estás buscando no existe, ha sido movida o está temporalmente no disponible.
                </p>
