...
@section('page-title', 'Nueva Limpieza Fosa Séptica')
@section('page-subtitle', 'Complete el formulario para registrar la limpieza de fosa séptica')
