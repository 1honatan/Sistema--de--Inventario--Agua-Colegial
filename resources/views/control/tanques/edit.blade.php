...
@section('title', 'Editar Limpieza de Tanque')
@section('page-title', 'Editar Limpieza de Tanque')
@section('page-subtitle', 'Modifique los datos del registro #' . $tanque->id)
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        <nav class="text-sm">
            ...
            <span class="mx-2 text-gray-500">/</span>
            <span class="text-gray-600">Editar Registro #{{ $tanque->id }}</span>
        </nav>
    </div>

    <div class="bg-white rounded-lg shadow-md p-8">
        <form action="{{ route('control.tanques.update', $tanque) }}" method="POST" id="tanqueForm">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date"
                               name="fecha_limpieza"
                               id="fecha_limpieza"
                               value="{{ old('fecha_limpieza', $tanque->fecha_limpieza->format('Y-m-d')) }}"
                               required
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="nombre_tanque"
                               id="nombre_tanque"
                               value="{{ old('nombre_tanque', $tanque->nombre_tanque) }}"
                               required
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="responsable"
                            ...
                            @foreach($personal as $persona)
                                <option value="{{ $persona->nombre_completo }}" {{ old('responsable', $tanque->responsable) == $persona->nombre_completo ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="supervisado_por"
                               value="{{ old('supervisado_por', $tanque->supervisado_por) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date"
                               ...
                               id="proxima_limpieza"
                               value="{{ old('proxima_limpieza', $tanque->proxima_limpieza ? $tanque->proxima_limpieza->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <textarea name="procedimiento_limpieza"
                              ...
                              placeholder="Describa el procedimiento de limpieza realizado...">{{ old('procedimiento_limpieza', $tanque->procedimiento_limpieza) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="productos_desinfeccion"
                              ...
                              placeholder="Liste los productos utilizados para la desinfección...">{{ old('productos_desinfeccion', $tanque->productos_desinfeccion) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="observaciones"
                              ...
                              placeholder="Ingrese observaciones adicionales (opcional)...">{{ old('observaciones', $tanque->observaciones) }}</textarea>
                    @error('observaciones')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
