            ...
            <div class="modern-card">
                ...
                <div class="modern-card-header">
                    <h3 class="modern-card-title">
                        ...
                        Editar Registro de Producción #{{ $produccion->id }}
                    </h3>
                    <p class="modern-card-subtitle">
                        Modifique los datos del registro de producción
                    </p>
                </div>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="productos[{{ $index }}][producto]" class="modern-select" required>
                                                    <option value="">Seleccione un producto...</option>
                                                    @foreach($productos ?? [] as $prod)
                                                        <option value="{{ $prod->nombre }}"
                                                            {{ ($producto->producto->nombre ?? '') == $prod->nombre ? 'selected' : '' }}>
                                                            {{ $prod->nombre }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="materiales[{{ $index }}][material]" class="modern-select">
                        ...
                        <div class="section-box border-blue">
                            ...
                            <div class="form-group">
                                <textarea name="observaciones"
                                          ...
                                          placeholder="Ingrese observaciones adicionales...">{{ old('observaciones', $produccion->observaciones) }}</textarea>
                                @error('observaciones')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
