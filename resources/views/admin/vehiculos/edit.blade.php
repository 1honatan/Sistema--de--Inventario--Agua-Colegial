...
@section('page-subtitle', 'Actualizar información del vehículo')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="observacion"
                              ...
                              placeholder="Ingrese cualquier observación relevante...">{{ old('observacion', $vehiculo->observacion) }}</textarea>
                    @error('observacion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
